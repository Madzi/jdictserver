...
/**
 * Insert the type's description here. Creation date: (28.07.01 21:39:40)
 * 
...
public interface IDatabase {
	 ...
	 * 
	 * @author Administrator 10.03.2004
	 */
	int getSize();

	/**
	 * This command searches an index for the dictionary, and reports words
	 * which were found using a particular strategy, together with their
	 * positions.
	 */
