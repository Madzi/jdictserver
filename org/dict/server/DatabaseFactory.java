...
/**
 * <p>
 * To sort the index file: java org.dict.server.DatabaseFactory indexFile
 * 
 * <p>
...
public class DatabaseFactory {
	static java.util.Hashtable<String, IDictEngine> fInstances = new java.util.Hashtable<String, IDictEngine>();
	...
	public static void addDatabases(IDictEngine eng, String cfg) {
		...
		for (int i = 0; i < configs.length; i++) {
			try {
				...
				log("Cannot create database " + configs[i]);
				log(e.toString());
			}
		}
		log("\nDatabases created!");
